    ...
    <div class="punch" ref="punch">
      ...
      <div class="top">
        <div class="item">
          ...
          <div class="value">
            <input type="text" v-model="username" disabled @blur="lostblur()" />
          </div>
        </div>
        <div class="item">
        ...
        <div class="item">
          ...
          <div class="value">
            <input type="text" v-model="className" disabled />
          </div>
        </div>
        <div class="nantong-address">
          ...
          <div class="chosedvalue">
            <div class="address">{{ chosedNantongValue.chosedNantongName }}</div>
            <div class="address">{{ chosedNantongValue.chosedXian }}</div>
          </div>
          <input type="text" disabled v-model="nowAddress" placeholder="详细地址：道路、门牌号、楼栋号、单元号" />
        </div>
      </div>
      <div class="first">
        <div class="item temp">
      ...
      <div class="second">
        ...
        <div v-if="chosedLeaveIndex === 1">
          <div class="item">
            <div class="name">
              <div class="cross-title">是否返回南通</div>
            </div>
          </div>
          <div
            class="item"
            v-for="(item, index) in crossList"
            :key="'0' + index"
            @click="chosedBack(index)"
          >
            <div class="name">
              <div class="cross-item">
                {{ item.value }}
                <div class="chosed-icon" v-if="chosedBackIndex === index ? true : false"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="item" @click="showArea()">
          <div class="name">
            <div class="cross-title">
              ...
              <div class="chosedValue" style="height:auto" v-if="isSverseas">
                <div class="value">海外地区</div>
              </div>
            </div>
      ...
      <div class="sixth" v-if="chosedSeeMedicalIndex === 1">
        ...
        <div class="item" v-if="chosedQuarantineIndex === 0">
        ...
        <div class="item" v-show="chosedQuarantineIndex === 1">
          <input
            type="text"
            v-model="homeAddress"
...
export default {
    ...
    getEnterpriseUser({
      ...
      if (resp.data.success && resp.data.data) {
        ...
        if (last) {
          ...
          vm.dateValue = last.returnNTDate ? new Date(last.returnNTDate) : "";
          if (vm.dateValue) {
            vm.chosedBackIndex = 1;
          } else {
            vm.chosedBackIndex = 0;
          }
  ...
  methods: {
    ...
    saveEnterprisePeriodPlace() {
      ...
      if (Number(vm.temperature) > 45 || Number(vm.temperature) < 35) {
        Toast({
          message: "请输入35℃-45℃体温！",
          iconClass: "icon icon-success"
        });
      ...
      if (!tempReg.test(Number(vm.temperature))) {
        Toast({
          message: "请输入35℃-45℃体温！",
          iconClass: "icon icon-success"
        });
      ...
      var params = {
        ...
        periodPlaceor: vm.periodPlaceor,
        returnNTDate:
        ...
        beforeReturnNtAddress: vm.isSverseas ? "" : vm.beforeBackAddress,
        overseasAddress: vm.isSverseas ? vm.beforeBackAddress : "",
        isolationType:
          vm.chosedQuarantineIndex === ""
            ? ""
    ...
    choseSeeMedical(index) {
      if (index === 1) {
        this.chosedQuarantineIndex = 0;
      } else {
        this.chosedQuarantineIndex = 1;
      }
    ...
    choseProvince(item) {
      ...
      if (item.name === "海外地区") {
        vm.isSverseas = true;
        vm.isShowAddressList = false;
        vm.isShowSelectValue = false;
        vm.chosedValues.province = "";
        vm.chosedValues.city = "";
        vm.chosedValues.area = "";
        return;
