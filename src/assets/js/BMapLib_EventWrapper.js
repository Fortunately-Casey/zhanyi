...
(function() {
  ...
  /**
     ...
     44  */
  BMapLib.EventWrapper.addDomListenerOnce = function(
    instance,
    eventName,
    handler
  ) {
    var eventListener = EventWrapper["addDomListener"](
      instance,
      eventName,
      function() {
        // 移除
  ...
  BMapLib.EventWrapper.addListener = function(instance, eventName, handler) {
    ...
    return new MapsEventListener(
      ...
      eventName,
      handler,
      MapsEventListener.MAP_EVENT
    );
  };

  BMapLib.EventWrapper.addListenerOnce = function(
    instance,
    eventName,
    handler
  ) {
    var eventListener = EventWrapper["addListener"](
      instance,
      eventName,
      function() {
        // 移除
